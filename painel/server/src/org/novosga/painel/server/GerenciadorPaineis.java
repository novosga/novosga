...
import org.novosga.painel.server.network.send.SenhaMsg;

/**
 * Gerencia os paineis cadastrados, mantendo eles em memória (performance).
 * Também é responsavel por manter o a memória sincronizada com o banco, ou
 * seja, garantir que um painel adicionado/atualizado/removido seja
 * adicionado/atualizado/removido no banco.
 *

...
class AcessoService
{
    ...
    public function isValidSession(Context $context)
    {
        ...
        $query = $em->createQuery("SELECT u.sessionId FROM Novosga\Entity\Usuario u WHERE u.id = :id");
     ...
     *
     * @param Novosga\Entity\Util\UsuarioSessao $usuario

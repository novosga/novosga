...
CREATE INDEX IX_fki_grupo_ibfk_1 ON unidades(grupo_id)
CREATE INDEX IX_fki_servicos_ibfk_1 ON servicos(macro_id)
...
ALTER TABLE servicos ADD CONSTRAINT FK_servicos_ibfk_1 FOREIGN KEY (macro_id) REFERENCES servicos(id)

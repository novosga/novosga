...
abstract class AbstractAtendimento implements AtendimentoInterface
{
    ...
    public function jsonSerialize(): array
    {
        ...
        return [
            ...
            'dataChegada' => $this->getDataChegada()->format('Y-m-d\TH:i:sP'),
            'dataChamada' => $this->getDataChamada()?->format('Y-m-d\TH:i:sP'),
            'dataInicio' => $this->getDataInicio()?->format('Y-m-d\TH:i:sP'),
            'dataFim' => $this->getDataFim()?->format('Y-m-d\TH:i:sP'),
            'dataAgendamento' => $this->getDataAgendamento()?->format('Y-m-d\TH:i:sP'),

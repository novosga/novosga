...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/style.css?v=<?php echo novosga\SGA::VERSION ?>" />
    <link rel="stylesheet" type="text/css" href="../themes/<?php echo novosga\view\SGAView::THEME ?>/style.css" />
    <script type="text/javascript" src="../js/jquery.js?v=<?php echo novosga\SGA::VERSION ?>"></script>
    <script type="text/javascript" src="../js/jquery-ui.js?v=<?php echo novosga\SGA::VERSION ?>"></script>
    <script type="text/javascript" src="../js/script.js?v=<?php echo novosga\SGA::VERSION ?>"></script>
    <script type="text/javascript" src="js/buzz.js?v=<?php echo novosga\SGA::VERSION ?>"></script>
    <script type="text/javascript" src="js/script.js?v=<?php echo novosga\SGA::VERSION ?>"></script>
</head>
<body>
    <table id="layout">
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            SGA.PainelWeb.Config.lang = '<?php echo novosga\SGA::defaultClientLanguage(); ?>';
            SGA.PainelWeb.init();
        });
    </script>
</body>
